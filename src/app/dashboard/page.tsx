    ...
    <div>
      ...
      <div className="pt-20 px-8 grid grid-cols-3 gap-4">
        <Project
          ...
          groupMembers={["Owen Krause", "Havel Kondah"]}
        />
        <Project
          title="Project Beta"
          ...
          groupMembers={["Jane Doe", "John Smith"]}
        />
        <Project
          title="Project Gamma"
          ...
          groupMembers={["Michael Jordan", "LeBron James"]}
        />
        <Project
          title="Project Delta"
          ...
          groupMembers={["Serena Williams", "Roger Federer"]}
        />
        <Project
          title="Project Alpha"
          shortDescription="Short info about Alpha"
